...
<div class="max-w-2xl mx-auto px-4">
    <div
        class="relative z-10 overflow-hidden rounded-xl bg-white/90 dark:bg-slate-800/90 backdrop-blur-md border border-slate-200/80 dark:border-slate-700/80 p-8 mb-10">
        <div class="flex flex-col md:flex-row md:items-start gap-8 mb-8 relative">
            ...
            <div>
                ...
                <div class="prose prose-slate dark:prose-invert max-w-none">
                    <p class="text-lg leading-relaxed text-slate-700 dark:text-slate-300 font-medium mb-4">
                        Selamlar, ben Okan 👋🏻
                    </p>
                </div>
            </div>
        ...
        <article class="prose prose-slate dark:prose-invert max-w-none">
            <div class="text-slate-600 dark:text-slate-400 space-y-4">
                <p>
    ...
    <div
        class="absolute top-0 right-0 -z-10 w-full h-[25rem] opacity-40 bg-gradient-to-b from-indigo-50 via-blue-50/50 to-transparent dark:from-indigo-950/30 dark:via-blue-950/20 dark:to-transparent">
    </div>
</div>